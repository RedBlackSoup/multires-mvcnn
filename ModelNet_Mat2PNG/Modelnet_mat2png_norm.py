...
# mat文件夹路径
ModelNet_filepath = 'ModelNet_voxelized_mat_norm'
# png文件夹路径
ModelNet_voxel_20 = 'ModelNet_voxel_20views_norm'
...
# convert modelnet_voxelized_mat to modelnet_voxel_20views
def main():
	...
	for classpath_index in ModelNet_classpath:
		...
		for vc_split in class_split:
			...
			# '.\ModelNet_voxelized_mat\bed\train'
			...
			for voxelmat_list_index in voxelmat_class_list:
					...
					# '.\ModelNet_voxelized_mat\bed\train\bed_0001.mat'
