...
parser.add_argument("-bs", "--batchSize", type=int, help="Batch size for the second stage", default=8)# it will be *20 images in each batch for mvcnn
...
parser.add_argument("-train_path", type=str, default="./data/ModelNet4_voxel_20views_30/*/train/*")
